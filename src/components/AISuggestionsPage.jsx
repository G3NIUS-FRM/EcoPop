      ...
      <div className="xl:col-span-8 space-y-4">
        ...
        {grouped.map((g) => (
          <section key={g.category} className="glass rounded-xl overflow-hidden">
            <header className="border-b border-white/5 px-4 py-2.5 bg-surface-300/55">
        ...
        {suggestions.length === 0 && (
          <div className="glass rounded-xl p-6 text-center">
            <div className="text-base mb-1 text-ink-300">◇</div>
...
function SuggestionFull({ s }) {
  ...
  return (
    <li className="rounded-md border border-white/8 bg-surface-200/55 p-3 hover:border-plasma-400/60 transition">
      ...
      <div className="text-[11px] text-neon-300 font-mono mt-1">▸ {s.action}</div>
      <p className="text-xs text-ink-300 mt-2 leading-relaxed">{s.rationale}</p>
